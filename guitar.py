...
class guitar(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "guitar")
        ...
        self.connect((self.audio_source_0, 0), (self.qtgui_time_raster_sink_x_0, 0))
...
def main(top_block_cls=guitar, options=None):
